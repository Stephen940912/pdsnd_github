"""
This program analyzes US Bikeshare data for several cities and
...
def get_filters():
    ...
    while city not in ['chicago', 'new york city', 'washington']:
        city = input("City is name is invalid! Please enter the correct city name: ").lower()
    ...
    while month not in['january','february','march','april','may','june','july','august','september','october','november','december']:
        month = input("Invalid entry!  Please enter the correct month:").lower()
    ...
    while day not in['sunday','monday','tuesday','wednesday','thursday','friday','saturday']:
        day = input("Invalid entry! Please enter the correct day: ").lower()
...
def station_stats(df):
    ...
    print("The most common start and end station is: {}".format(
...
def user_stats(df, city):
    ...
    print("Total counts of various user types:")
    print(df['User Type'].value_counts())

    if city != 'washington':
        # Display counts of gender
        print("Total counts of each gender:")
